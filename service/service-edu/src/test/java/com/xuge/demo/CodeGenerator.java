...
public class CodeGenerator {
  ...
  public void run() {
    ...
    gc.setOutputDir("D:\\Java架构师资料\\Study\\项目\\guli_parent\\service\\service-edu" + "/src/main/java"); //输出目录

    gc.setAuthor("xuge"); //作者名
